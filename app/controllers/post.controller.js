...
exports.add = async (req, res) => {
    try {
        ...
        let userLogin = req.body.post_by;
        fields.post_by = userLogin;
...
exports.getMain = async (req, res, next) => {
    try {
        ...
        result.push(csr)
        result.push(event)
        // console.log(JSON.stringify(com_news) + " 1 ")
        // console.log(csr+ " 2 ")
        // console.log(event+ " 3 ")
        res.json(result);
    } catch (err) {
